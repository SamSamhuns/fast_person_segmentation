...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Dump hdf5 model to checkpoint folder")
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        "--save_ckpt_dir",
        type=str,
        help="folder path to save ckpt file",
        default="models",
    )
    parser.add_argument(
        "-c",
        ...
        type=str,
        help="ckpt file name",
        default="frozen_model.ckpt",
    )
    args = parser.parse_args()

    main(args.model_path, args.save_ckpt_dir, args.save_ckpt_name)

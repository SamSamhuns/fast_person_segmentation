...
def main():
    ...
    parser.add_argument('-sp', '--save_tflite_dir', type=str, default="models",
                        help='folder path to save tflite file. Default: models')
    parser.add_argument('-p', '--save_tflite_name', type=str, default="model.tflite",
                        help='tflite file name. Default: model.tflite')
    args = parser.parse_args()

    tflite_save_path = os.path.join(
        args.save_tflite_dir, args.save_tflite_name)

...
def convert(model_path, weight_save_path, json_save_path):
    ...
    print(
        f"Saved weights to {weight_save_path} and json config to {json_save_path}")

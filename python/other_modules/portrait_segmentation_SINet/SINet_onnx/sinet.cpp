...
int main(int argc, char** argv)
{
    ...
    while (waitKey(1) < 0)
    {
        ...
        resize(result, result, Size(1200, 720), INTER_CUBIC);
...
Compile:  g++ sinet.cpp `pkg-config opencv --cflags --libs`
          g++ $(pkg-config --cflags --libs /usr/local/Cellar/opencv/4.5.0_5/lib/pkgconfig/opencv4.pc) -std=c++11 -Wall -Wextra sinet.cpp -0 sinet_webcam
Run: ./a.out weights/SINet_Softmax.onnx whitehouse.jpeg smooth
     ./sinet_webcam weights/SINet_Softmax.onnx whitehouse.jpeg nosmooth

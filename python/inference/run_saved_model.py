...
def inference_video(
    ...
    print("model output name & structure: ", model_inference.structured_outputs)
...
def main():
    parser = get_cmd_argparser(default_model="models/selfie_seg/144x256")
    args = parser.parse_args()
    args.disp_wh_size = tuple(map(int, args.disp_wh_size))
    inference_video(
        args.source_vid_path,
        args.bg_img_path,
        args.model_path,
